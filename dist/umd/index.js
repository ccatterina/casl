(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.casl = {}, global.ucast.mongo2js));
  ...
  var buildMongoQueryMatcher = function buildMongoQueryMatcher(instructions, interpreters, options) {
    return mongo2js.createFactory(_extends({}, defaultInstructions, instructions), _extends({}, defaultInterpreters, interpreters), options);
  };
  var mongoQueryMatcher = mongo2js.createFactory(defaultInstructions, defaultInterpreters);
